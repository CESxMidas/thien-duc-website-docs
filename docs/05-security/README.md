# 05 — Security · Website Thiên Đức

> **Trạng thái:** Đang dùng (index thư mục bảo mật)
> **Cập nhật:** 2026-07-16
...
1. [findings-summary.md](findings-summary.md) — tóm tắt 1 trang (10 finding: 2 HIGH, 5 MEDIUM, 3 LOW).
2. [security-audit-phase-1.md](security-audit-phase-1.md) — báo cáo đầy đủ 10 mục.
3. [phase-2-verification-gate.md](phase-2-verification-gate.md) — kiểm chứng các fix HIGH.
4. [security-overview.md](security-overview.md) · [threat-model.md](threat-model.md) · [remediation-plan.md](remediation-plan.md) — khung, sẽ bổ sung.

> ⚠️ **Ngày & phạm vi:** báo cáo security-audit dưới đây là mốc **2026-07-14**. Trạng thái bảo mật *hiện hành* (nhiều finding đã vá) được phản ánh trong [Audit Baseline 2026-07-16](../08-audits-and-reports/current/2026-07-16-audit-baseline.md) mục 5 (Reliability & security). Đừng gộp finding cũ vào trạng thái hiện tại mà không đối chiếu ngày.


## 📁 Files

### `security-audit-phase-1.md` (Full Report)
...
- `../07-deployment/deployment-guide.md` — Current deployment procedures
- `../04-implementation/implementation-plan.md` — Sprint status & work tracking
- `../01-requirements/open-questions.md` — Open questions (may need security input)
