...
- `JWT_ACCESS_SECRET` bất kỳ. Mail (Resend)/Cloudinary/Sentry bỏ trống — no-op an toàn.
...
- **Unit backend mock Prisma/MailService** — không đụng DB/mail (Resend) thật, không lộ secret.
