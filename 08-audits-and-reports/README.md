...
| [current/BAO-CAO-TIEN-DO-VA-KIEM-THU-WEBSITE-CMS-THIEN-DUC.docx](current/BAO-CAO-TIEN-DO-VA-KIEM-THU-WEBSITE-CMS-THIEN-DUC.docx) | Báo cáo tiến độ & kiểm thử Website + CMS trình lãnh đạo (Word) — tiến độ theo nhóm chức năng, ma trận test-case, hạng mục còn mở, rủi ro | Đang dùng |
